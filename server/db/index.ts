...
const { DataSource, Entity, Column, CreateDateColumn, OneToMany } = require('typeorm');
const { PrimaryGeneratedColumn, UpdateDateColumn, ManyToOne }  = require('typeorm');
...
.catch((err: any) => console.error('AppDataSource has not been initialized', err))
...
export class JourneyProgress {
  ...
  @ManyToOne(() => Journey, (journey: Journey) => journey.progress)
  journey: Journey;
...
export class UserAchievement {
  ...
  @ManyToOne(() => Achievement, (achievement: Achievement) => achievement.users)
